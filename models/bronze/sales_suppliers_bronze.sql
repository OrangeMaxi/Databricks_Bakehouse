...
-- MAGIC %md
-- MAGIC # sales_suppliers Bronze DLT
-- MAGIC
-- MAGIC ## Overview
...
-- MAGIC - **Source Path**: `/Volumes/dev_catalog/bronze/landing_zone/sales_suppliers.parquet`
-- MAGIC - **Target Catalog**: `dev_catalog`
-- MAGIC - **Target Schema**: `bronze`
-- MAGIC - **Target Table**: `sales_suppliers`
-- MAGIC - **Layer**: Bronze
-- MAGIC 
-- MAGIC ## Change Log
-- MAGIC | Date       | Developer   | Description                          |
-- MAGIC |------------|-------------|--------------------------------------|
-- MAGIC | 2024-07-30 | Engineer    | Initial version for sales_suppliers. |
-- MAGIC 
-- MAGIC ## Usage
...
AS SELECT * FROM read_files("/Volumes/dev_catalog/bronze/landing_zone/sales_suppliers.parquet", format => "parquet");