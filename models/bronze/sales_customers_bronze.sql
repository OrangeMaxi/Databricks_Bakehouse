...
-- MAGIC %md
-- MAGIC # sales_customers Bronze DLT
-- MAGIC
-- MAGIC ## Overview
...
-- MAGIC - **Source Path**: `/Volumes/dev_catalog/bronze/landing_zone/sales_customers.parquet`
-- MAGIC - **Target Catalog**: `dev_catalog`
-- MAGIC - **Target Schema**: `bronze`
-- MAGIC - **Target Table**: `sales_customers`
-- MAGIC - **Layer**: Bronze
-- MAGIC 
-- MAGIC ## Change Log
-- MAGIC | Date       | Developer   | Description                          |
-- MAGIC |------------|-------------|--------------------------------------|
-- MAGIC | 2024-07-30 | Engineer    | Initial version for sales_customers. |
-- MAGIC 
-- MAGIC ## Usage
...
CREATE OR REFRESH STREAMING TABLE dev_catalog.bronze.sales_customers
AS SELECT * FROM read_files("/Volumes/dev_catalog/bronze/landing_zone/sales_customers.parquet", format => "parquet");